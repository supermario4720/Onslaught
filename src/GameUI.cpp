...
GameUI::GameUI(sf::Font& font, sf::RenderWindow& window, Camera* camPtr)
    ...
    cameraPtr(camPtr), townArrow(TextureManager::getInstance().getTexture("Pointer")), isKeyboardVisible(true)
{
...
void GameUI::pauseButtonActive(bool active) {
    pauseButton.setActive(active);
}

void GameUI::setKeyboardVisibility(bool visibility) {
